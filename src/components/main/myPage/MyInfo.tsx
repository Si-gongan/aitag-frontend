      ...
      <div className="mt-[41px] w-[996px]">
        ...
        <div className="flex justify-between w-[948px] h-[382px] mt-[80px] ml-[70px]">
          <div className="w-[248px] h-[314px] mt-[20px]">
            <div className="image-container mb-4">
              {user.profileImgUrl ? (
                <img
                  ...
                  className="border-[#2C5AE9] border-[1px] rounded-full mx-auto"
                />
              ) : (
            ...
            <div className="flex justify-between items-center">
              <label
                htmlFor="upload"
                className="flex justify-center items-center w-[120px] h-[54px] mt-[64px] hover:bg-[#F2F6FE] hover:border-[#4C80F1] hover:text-[#2C5AE9] bg-[#F8FAFB] border-[#CED3D6] border-[1px] rounded-[0.25rem] text-[#4D5256]">
                이미지 업로드
                <input
                  id="upload"
                  type="file"
              ...
              <button
                ...
                className="w-[120px] h-[54px] mt-[64px] hover:bg-[#F2F6FE] hover:border-[#4C80F1] hover:text-[#2C5AE9] bg-[#F8FAFB] border-[#CED3D6] border-[1px] rounded-[0.25rem] text-[#4D5256]">
                이미지 삭제
              </button>
            </div>
          </div>
          <div className="relative w-[600px] h-[382px]">
            <div className="flex justify-between items-center mb-[28px]">
              ...
              <div className="border h-53 rounded-lg w-full py-10 px-15 text-16 text-[#4D5256] focus:outline-none">
                {user?.name}{' '}
              </div>
            </div>
            <div className="flex justify-between items-center mb-[28px]">
            ...
            <div className="flex justify-between items-center mb-[28px]">
              ...
              <button
                ...
                className="text-left border h-53 rounded-lg w-full py-10 px-15 text-16 text-[#4D5256] focus:outline-none bg-[#F8FAFB]">
                비밀번호 변경하기
              </button>
            </div>
          </div>
        ...
        <div>
          <button
            ...
            className="w-[233px] h-[70px] mt-[130px] ml-[785px] bg-[#4C80F1] rounded-[0.25rem] text-17 text-[#FFFFFF]"
            style={{ boxShadow: '0px 1px 2px 0px #4C80F180' }}>
            저장하기
          </button>
        </div>
        {showModal && (
