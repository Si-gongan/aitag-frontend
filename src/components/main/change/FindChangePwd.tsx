        ...
        {!message ? (
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-30 mx-auto relative px-8">
              ...
              <input
                className="border h-53 rounded-lg w-full py-10 px-15 text-gray-700 text-16focus:outline-none"
                id="pwdcheck"
                type={showPwd ? 'text' : 'password'}
            ...
            <div className="px-8">
              <button
                className="w-full h-53 text_16 bg-[#4C80F1] hover:bg-blue-700 text-white py-8 rounded-lg focus:outline-none mb-30"
                type="submit">
                비밀번호 변경하기
              </button>
              <Link href={PATH.LOGIN}>
                <button className="border w-full h-53 text_16 text-[#4D5256] py-8 rounded-lg focus:outline-none">
                  로그인으로 돌아가기
                </button>
              </Link>
            </div>
          ...
          <div>
            ...
            <Link href={PATH.LOGIN}>
              <button className="w-full h-53 text_16 bg-[#4C80F1] text-white py-8 rounded-lg focus:outline-none mb-30">
                로그인
              </button>
            </Link>
          </div>
